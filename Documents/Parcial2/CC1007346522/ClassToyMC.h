...
// Fri May 26 19:29:20 2023 by ROOT version 6.28/00
// from TTree Tree2/Tree2
// found on file: ToyMC_5.root
//////////////////////////////////////////////////////////
...
#ifdef ClassToyMC_cxx
ClassToyMC::ClassToyMC(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ToyMC_5.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ToyMC_5.root");
      }
...
ClassToyMC::~ClassToyMC()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ClassToyMC::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ClassToyMC::LoadTree(Long64_t entry)
{
...
void ClassToyMC::Init(TTree *tree)
{
...
void ClassToyMC::Show(Long64_t entry)
{
...
Int_t ClassToyMC::Cut(Long64_t entry)
{
