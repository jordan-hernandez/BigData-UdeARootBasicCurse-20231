...
void fit_2dim()
{
    ...
    t->SetBranchAddress("Bcmass", &Bcmass);
    t->SetBranchAddress("tau", &tau);
    t->SetBranchAddress("tauerror", &tauerror);
    ...
    data.plotOn(frame, Name("Data"), MarkerColor(kBlack), MarkerSize(0.5));
    BcmTau.plotOn(frame, LineWidth(2), Name("fit"), LineColor(kGreen+2));
    frame->Draw();
    ...
    data.plotOn(frame1, Name("Data"), MarkerColor(kBlack), MarkerSize(0.5));
